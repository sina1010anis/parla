    ...
    <view-product :data="{{$data}}" :image="{{$data->image_product}}">
            ...
            <template #color_product>
                @foreach($data->color as $color)
                    <li title="test" class="obj-center text-center p-2 color-b-600 m-2 d-inline-block"
                        style="background-image: url('/image/color/{{$color->color->code}}')"><span
                            class="f-11 color-b-100 float-start"> {{$color->color->name}}</span>
                    </li>
                @endforeach
            </template>
            <template #size_all>
            ...
            <template #title_view>
                <blockquote class="blockquote">
                    <h5 class="color-b-900" dir="rtl" align="right">{{$data->name}}</h5></blockquote>
            ...
            <template #price_product>
                <p dir="rtl" align="right" class="f-14" style="color: #ff5454">قیمت: <b
                        class="f-20 color-b-900">{{$data->size->first()->price}}</b></p>
            </template>
