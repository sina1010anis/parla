<?php
namespace App\Repository\FilePay;
/*
...
class zarinpal_function
{
	...
	public function request($MerchantID, $Amount, $Description="", $Email="", $Mobile="", $CallbackURL, $SandBox=true, $ZarinGate=false)
	{
