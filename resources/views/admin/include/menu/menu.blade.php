<div class="page-new page-edit-menu-page overflow-hidden">
    ...
    <button @click="edit_name_menu_admin(1)" type="button" class="btn btn-lg btn-primary f-13 ms-3 mt-3">
        ویرایش
    </button>
...
<div class="page-new page-new-admin-as overflow-hidden">
    ...
    <button @click="edit_menu_admin(1)" type="button" class="btn btn-lg btn-danger f-13 ms-3 mt-3">
        بله
    </button>
    <button @click="cls_page_new_comment_reply" type="button" class="btn btn-lg btn-light f-13 ms-3 mt-3">
        خیر
