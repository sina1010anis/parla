...
@section('admin')
    <div class="row p-2 ">
        <div class="col-md-6  bg-white p-4 rounded-3 shadow">
            <p class="f-16 font-S color-b-700 text-end">صفحه رنگ ها</p>
            <form action="{{route('admin.new.color')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="formFilte"  class="form-label f-13 color-b-500">نام</label>
                    <input name="name" class="form-control" type="text" id="formFilte">
                </div>
                <div class="mb-3">
    ...
    <div class="page-new page-new-delete-banner-center-as overflow-hidden">
        ...
        <button @click="delete_image_center('color_as')" type="button" class="btn btn-lg btn-danger f-13 ms-3 mt-3">
            بله
        </button>
